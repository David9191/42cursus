...
int main(void)
{
	int year = 2022, month = 8, day = 24;
	float left_blackhole = 8;
...
void calculate(int *year, int *month, int *day)
{
	if (((*month == 2 || *month == 4 || *month == 6 || *month == 9 || *month == 11) && *day > 30) || ((*month == 1 || *month == 3 || *month == 5 || *month == 7 || *month == 8 || *month == 10 || *month == 12) && *day > 31))
	{
